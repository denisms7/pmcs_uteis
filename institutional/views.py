    ...
    def get_queryset(self):
        ...
        if query_normalized:
            queryset = queryset.filter(
                Q(person__icontains=query) | Q(person_num__icontains=query_normalized) | Q(sector__icontains=query) | Q(sector_num__icontains=query_normalized) | Q(address__name__icontains=query) | Q(address__phone__icontains=query_normalized)
            )
        return queryset
